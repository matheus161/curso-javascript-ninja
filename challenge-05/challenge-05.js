...
*/
var myarray = [10, 'Matheus', null, { a: 1 }, function() {}];
...
*/
var myArray2 = [10.4, false. 'Matheus', { a : 1 }, [null, 1, true] ];
...
*/
console.log('O autor do livro ' + bookName +  ' é ' + book(booName).autor  '.')
